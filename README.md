...
<img src="https://github.com/user-attachments/assets/b5205646-4eb2-4c4f-86e4-759105e2353a" width="40%">
...
- **固定費の自動計上:** 住居費や保険料など、毎月決まって発生する固定費をテンプレートとして登録できます。登録した項目は毎月の支出として自動的に計上されるため、手動で入力する手間が省けます。
- **予算設定機能:** 月ごとの総合予算とカテゴリ別の詳細な予算を設定できます。ダッシュボードで予算に対する支出の進捗状況をリアルタイムで追跡し、計画的な家計管理をサポートします。
- **共有機能:** 月の家計簿サマリー（収入、支出、残高、支出内訳トップ10）を、LINEやメールで簡単に共有できます。カテゴリ別支出の円グラフと金額一覧を画像として添付するオプションもあり、家族やパートナーとの情報共有がスムーズに行えます。
...
- **その他:**
  ...
  - [html-to-image](https://github.com/bubkoo/html-to-image): グラフを画像として共有するために使用
